...
| Track player improvement by hand | Most/Least Improved tab (on Standings) ranks all qualified members by PTM change from season start |
...
| Keep track of points-to-make manually | Shows per-player PTM with inline delta arrow after each tournament |
