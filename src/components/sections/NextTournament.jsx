...
export default function NextTournament() {
  ...
  return (
    <section className="bg-charcoal border-y border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          ...
          <div>
            ...
            <h2 className="text-offwhite text-2xl sm:text-3xl font-serif font-bold mb-1">{next.name}</h2>
            <p className="text-gray-400 font-sans text-sm mb-3">
              {formatDate(next.date)} &nbsp;·&nbsp; {next.course}
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="text-xs bg-forest text-green-300 px-2.5 py-1 rounded-full font-sans">
                {next.format}
              </span>
          ...
          <div className="flex flex-col items-start lg:items-end gap-4">
            ...
            <Link to="/schedule" className="text-sm text-gold hover:text-gold-light font-sans font-medium transition-colors">
              Full schedule →
            </Link>
          </div>
        </div>
